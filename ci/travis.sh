...
if [ "$TRAVIS_PULL_REQUEST" != "false" ]; then
    ...
    ./gradlew clean generatePomFileForMavenBomPublication artifactoryPublish --stacktrace --refresh-dependencies
    ...
    ./gradlew clean generatePomFileForMavenBomPublication bintrayUpload --stacktrace --refresh-dependencies
else
    # Feature Branch
